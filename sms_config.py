...
if __name__ == "__main__":
    ...
    # 测试发送
    test_mobile = "17681914520"
    
    # 方式1：直接发送
    # sms.send(test_mobile, "这是一条测试短信")
    
    # 方式2：发送告警
    # sms.alert(test_mobile, "192.168.1.1", "离线")
    
    # 方式3：发送通知
    # sms.notify(test_mobile, "系统通知", "服务器将于今晚22:00进行维护")
    
    # 方式4：批量发送
    # sms.send_batch(["13800138000", "13900139000"], "批量测试")
    
    # 方式5：使用快捷函数
    # send_sms(test_mobile, "快捷函数测试")
    # send_alert(test_mobile, "192.168.1.1", "离线")
    
    print("短信通知模块已加载，请取消注释上面的测试代码进行测试")
